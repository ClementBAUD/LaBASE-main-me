...
export const environment = {
  production: false,
  version: "1.1.2",
   //api:'https://www.mytchek.fr/nodejs/api/v1/',
  //  api:'https://www.apiba.fr/api/v1/',
   api:'http://localhost:8000/api/v1/',
  vapidkey:{
    publicKey:"BEqXGfa0rJ9CIUXszFD3TrcRiBhdlWGI13_Uo-QXnKCZQc4pDStignN8xW5_EkiDmspPpH4daMmj1cVoywwbFn8"
  },
  firebase: {
