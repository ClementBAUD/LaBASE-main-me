...
@Component({
  selector: 'app-commande-no-recupere',
  templateUrl: './commande-no-recupere.component.html',
  styleUrls: ['./commande-no-recupere.component.css']
})
export class CommandeNoRecupereComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.listeCommandeSub= this.commandesService.commandeMagNoRecup$.subscribe(
      (res:[])=>{
    ...
    this.commandesService.getCommandeMagasinANonRecup(idMagasin);
